...
class Platforms:
    ...
    def scroll_platform(self)->None:
        """Translate the platform horizontally to the left by the scroll speed.

        Updates the `x` attribute with the new position.
        """
    ...
    def new_platform(self, previous_height: int, x_of_last_platform: int)->None:
        """Generate a new platform to the right of the last platform.

        The new platform will have a random y-coordinate within a certain range of the
        previous platform.

        Args:
            previous_height (int): The y-coordinate of the previous platform.
            x_of_last_platform (int): The x-coordinate of the last platform.
        """
    ...
    def get_platform_height(self) -> int:
        ...
        Returns:
            int: The x-coordinate of the platform.
        """
        return self.y
    ...
    def reset_scroll_speed(self)->None:
        """Reset the scroll speed of the platform.

        Sets the scroll speed of the platform back to its initial scroll speed.
        """
