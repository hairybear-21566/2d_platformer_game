...
class GameBackground:
    ...
    def update_background(self) -> None:
        """
        Updates the background's position and image object on the canvas, looping around to the other side of the screen
        if the image is fully off-screen after translation.
